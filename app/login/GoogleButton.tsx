...
const GoogleButton: React.FC<GoogleButtonProps> = ({ googleLogoSrc }) => {
  return (
    <div className="flex flex-col text-3xl text-black max-md:max-w-full">
      <img loading="lazy" src={googleLogoSrc} alt="Google Logo" className="object-contain self-center max-w-full aspect-[3.02] w-[251px]" />
