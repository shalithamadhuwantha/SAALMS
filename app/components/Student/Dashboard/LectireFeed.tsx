...
const LectureFeeds: React.FC = () => {
  ...
  if (!lectureData) {
    ...
    return (
      <div className="card flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 text-white shadow-lg rounded-lg p-6">
        ...
        <h2 className="text-xl font-semibold">No Upcoming Lectures</h2>
        <p className="text-md text-white text-opacity-80 mt-2">
    ...
    <div className="card bg-gradient-to-br from-blue-500 to-purple-600 text-white shadow-xl">
      <div className="card-body">
        ...
        <div className="card-actions justify-end mt-4">
          ...
          <button
            onClick={() => router.push("/Student/Class/" + lectureData.code)}
            className="btn btn-outline btn-accent"
          >
            <IoOpenOutline size={20} /> Open
          </button>
        </div>
      </div>
    </div>
