...
const SideNav: React.FC = () => {
  const navItems = [
    ...
    { icon: <IoIosSchool className="text-2xl" />, text: "My Courses" },
    { icon: <MdOutlineCalendarMonth className="text-2xl" />, text: "Time Table" },
    { icon: <IoMdSettings className="text-2xl" />, text: "Settings" },
  ];

  return (
    <aside className="col-span-1 bg-gradient-to-b from-gray-900 to-gray-800 shadow-xl p-6 flex flex-col h-screen">
