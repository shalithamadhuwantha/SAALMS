          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <form onSubmit={handleSubmit} className="flex-grow">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
                {[
                  { icon: MdPersonOutline, name: 'name', label: 'Name', color: 'text-indigo-400', editable: true },
                  { icon: MdEmail, name: 'email', label: 'Email', color: 'text-green-400', editable: true },
                  { icon: MdSchool, name: 'staffId', label: 'Staff ID', color: 'text-purple-400', editable: false },
                  { icon: MdBusinessCenter, name: 'department', label: 'Department', color: 'text-pink-400', editable: true },
                  { icon: MdBusinessCenter, name: 'position', label: 'Position', color: 'text-yellow-400', editable: true },
                  { icon: MdPersonOutline, name: 'mobile', label: 'Mobile', color: 'text-orange-400', editable: true },
                ].map((field) => (
